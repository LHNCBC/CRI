...
FROM dua_052538_nwi388.CONDITION_OCCURRENCE_$job co;
...
insert into dua_052538_nwi388.condition_era_1s1y as
...
FROM dua_052538_nwi388.DRUG_EXPOSURE_$job d
...
drop table if exists dua_052538_nwi388.drug_era_test;
create table dua_052538_nwi388.drug_era_test
SELECT row_number() OVER (
		ORDER BY person_id
		) AS drug_era_id
	,person_id
