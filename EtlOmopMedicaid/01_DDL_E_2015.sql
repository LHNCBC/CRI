...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','1','start_15',current_timestamp(), null);

-- COMMAND ----------

drop table if exists dua_052538_nwi388.inpatient_header_15;
create table dua_052538_nwi388.inpatient_header_15(
...
drop table if exists dua_052538_nwi388.inpatient_line_15;
create table dua_052538_nwi388.inpatient_line_15(
BENE_ID string,
CLM_ID string,
...
drop table if exists dua_052538_nwi388.other_services_header_15;
create table dua_052538_nwi388.other_services_header_15(
BENE_ID string,
BLG_PRVDR_NPI string,
BLG_PRVDR_SPCLTY_CD string,
CLM_ID string,
...
drop table if exists dua_052538_nwi388.other_services_line_15;
create table dua_052538_nwi388.other_services_line_15(
BENE_ID string,
CLM_ID string,
HCBS_SRVC_CD string,
...
drop table if exists dua_052538_nwi388.long_term_header_15;
create table dua_052538_nwi388.long_term_header_15(
BLG_PRVDR_NPI string,
clm_id string,
state_cd string,
bene_id string,
...
drop table if exists dua_052538_nwi388.long_term_line_15;
create table dua_052538_nwi388.long_term_line_15(
clm_id string,
state_cd string,
SRVC_PRVDR_NPI string,
bene_id string,
...
drop table if exists dua_052538_nwi388.rx_header_15;
create table dua_052538_nwi388.rx_header_15(
BENE_ID string,
BLG_PRVDR_NPI string,
...
drop table if exists dua_052538_nwi388.rx_line_15;
create table dua_052538_nwi388.rx_line_15( 
bene_id string,
state_cd string,
clm_id string,
ndc string,
...
--inpt_header
insert into dua_052538_nwi388.inpatient_header_15
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','4','inpatient_header_15',current_timestamp(), null);

-- COMMAND ----------

--inpt_line
insert into  dua_052538_nwi388.inpatient_line_15
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','5','inpatient_line_15',current_timestamp(), null);

-- COMMAND ----------

--ot_header
insert into dua_052538_nwi388.other_services_header_15
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','6','other_services_header_15',current_timestamp(), null);

-- COMMAND ----------

--ot_line
insert into dua_052538_nwi388.other_services_line_15
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','7','other_services_line_15',current_timestamp(), null);

-- COMMAND ----------

--lt_header
insert into dua_052538_nwi388.long_term_header_15
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','8','long_term_header_15',current_timestamp(), null);

-- COMMAND ----------

--lt_line
insert into dua_052538_nwi388.long_term_line_15
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','9','long_term_line_15',current_timestamp(), null);

-- COMMAND ----------

--rx_header
insert into dua_052538_nwi388.rx_header_15
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','10','rx_header_15',current_timestamp(), null);

-- COMMAND ----------

--rx_line
insert into dua_052538_nwi388.rx_line_15
select $rx_line from(
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','11','rx_line_15',current_timestamp(), null);

-- COMMAND ----------

insert into dua_052538_nwi388.log values('$job_id','EXTRACT','12','end_15',current_timestamp(), null);