...
--2020
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','1','start_2020',current_timestamp(), null);
...
--demog_elig_base
insert into dua_052538_nwi388.demog_elig_base select $demog_elig_base from dua_052538.tafr20_demog_elig_base where bene_id is not null;

-- COMMAND ----------

insert into dua_052538_nwi388.log values('$job_id','EXTRACT','2','demog_elig_base_2020',current_timestamp(), null);

-- COMMAND ----------

--demog_elig_dates
insert into dua_052538_nwi388.demog_elig_dates select $demog_elig_dates from dua_052538.tafr20_demog_elig_dates where bene_id is not null;

-- COMMAND ----------

insert into dua_052538_nwi388.log values('$job_id','EXTRACT','3','demog_elig_dates_2020',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','4','inpatient_header_2020',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','5','inpatient_line_2020',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','6','other_services_header_2020',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','7','other_services_line_2020',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','8','long_term_header_2020',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','9','long_term_line_2020',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','10','rx_header_2020',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','11','rx_line_2020',current_timestamp(), null);

-- COMMAND ----------

insert into dua_052538_nwi388.log values('$job_id','EXTRACT','12','end_2020',current_timestamp(), null);