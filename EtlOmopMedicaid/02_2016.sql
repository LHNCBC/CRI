...
--2016
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','1','start_2016',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','2','demog_elig_base_2016',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','3','demog_elig_dates_2016',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','4','inpatient_header_2016',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','5','inpatient_line_2016',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','6','other_services_header_2016',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','7','other_services_line_2016',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','8','long_term_header_2016',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','9','long_term_line_2016',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','10','rx_header_2016',current_timestamp(), null);
...
insert into dua_052538_nwi388.log values('$job_id','EXTRACT','11','rx_line_2016',current_timestamp(), null);

-- COMMAND ----------

insert into dua_052538_nwi388.log values('$job_id','EXTRACT','12','end_2016',current_timestamp(), null);